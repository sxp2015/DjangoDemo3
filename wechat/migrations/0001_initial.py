# Generated by Django 4.0 on 2023-09-15 02:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cellphone', models.CharField(default='', max_length=11, verbose_name='手机号码')),
                ('city', models.CharField(default='', max_length=255, verbose_name='城市')),
                ('gender', models.CharField(default='', max_length=255, verbose_name='性别')),
                ('province', models.CharField(default='', max_length=255, verbose_name='省份')),
                ('token', models.CharField(default='', max_length=255, verbose_name='登录令牌')),
